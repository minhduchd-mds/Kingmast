...
if(!/not a physical HIL result/i.test(doc)||!/does not qualify target hardware/i.test(doc))fail('realtime recovery documentation must explicitly reject physical HIL and target-hardware claims');
