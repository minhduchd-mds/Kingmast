...
const patterns:Array<{intent:AssistantIntent;tools:AssistantTool[];terms:string[];parked?:boolean;hint:string}>=[
  ...
  {intent:'settings',tools:['settings.summary'],terms:['settings','setting','preferences','cài đặt','cai dat','tùy chọn','tuy chon','thiết lập','thiet lap'],parked:true,hint:'Explain settings; deep edits remain parked-only.'},
