...
expect('realtime validates telemetry provenance before publishing',realtime.includes("parsed.source==='edge'&&frame.vehicle.source!=='gnss'")&&realtime.includes("parsed.source==='simulator'&&frame.vehicle.source!=='simulator'"));
