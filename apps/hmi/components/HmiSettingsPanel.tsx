...
import { Bell, BellOff, Camera, Gauge, LockKeyhole, Mic, Moon, Route, ShieldCheck, SlidersHorizontal, Sun, UserRound, Wifi, Wrench } from 'lucide-react';
...
const sections:Array<{key:SettingsSection;label:string;icon:typeof SlidersHorizontal}>=[{key:'assistance',label:'Assistance',icon:SlidersHorizontal},{key:'connectivity',label:'Connectivity',icon:Wifi},{key:'vehicle',label:'Vehicle & updates',icon:Wrench},{key:'privacy',label:'Privacy',icon:LockKeyhole},{key:'profile',label:'Profile',icon:UserRound}];
...
export default function HmiSettingsPanel(props:HmiSettingsPanelProps){
  ...
  return <div className="viewEnter settingsWorkspace" data-testid="hmi-settings"><section className="surface settingsSurface">
    ...
    <p className="settingsIntro">Driving-critical information stays simple. Setup, service, privacy and profile changes use parked-only progressive disclosure.</p>
