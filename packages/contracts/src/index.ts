...
export interface SurroundRuntimeStatus { availability:DriverAssistAvailability; observedAtMs:number|null; ageMs:number|null; cameraCount:number; calibratedCameraCount:number; synchronizedCameraCount:number; readyCameraCount:number; maxReprojectionErrorPx:number|null; calibrationUncertaintyPx:number|null; geometryConfidence:number; fullyReady:boolean; reason:string; visualizationOnly:true; }
